...
envsubst ./helm/values-gdpr.yaml > ./helm/values-gdpr-resolved.yaml

helm template -s templates/graphdb.yaml -f ./helm/values-gdpr-resolved.yaml pv ./helm/pv | k3s kubectl apply -f -
